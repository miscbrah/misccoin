...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "MiscCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"MiscCointools.com", "dnsseed.MiscCointools.com"},
    {"MiscCoinpool.org", "dnsseed.MiscCoinpool.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"MiscCointools.com", "testnet-seed.MiscCointools.com"},
    {"MiscCoinpool.org", "testnet-seed.MiscCoinpool.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. MiscCoin is probably already running."), addrBind.ToString().c_str());
        else
